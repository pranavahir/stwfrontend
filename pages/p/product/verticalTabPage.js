                            ...
                            <div className="">
                                ...
                                {(!data || !data.product || data.product.length === 0 || loading) ?
                                    ...
                                    <Row>
                                        ...
                                        <DetailsWithPrice symbol={symbol} item={data.product} changeColorVar={changeColorVar} navOne={state.nav1} addToCartClicked={() => addToCart(data.product)} />
                                        </Col>
                                    </Row>
                                }
